...
Seq = "" 
Bestand = open("/home/sasnee/Documents/School Bio-informatica/Bio-informatica/Blok 1/Week 2/Opdracht 2/MMrna seq.txt", "r")
for line in Bestand:
...
print("Mus musculus GC_percentage = 54.52%")
