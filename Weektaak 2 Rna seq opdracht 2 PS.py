...
Seq = "" 
Bestand = open("/home/sasnee/Documents/School Bio-informatica/Bio-informatica/Blok 1/Week 2/Opdracht 2/PSrna.txt", "r")
for line in Bestand:
...
print("Pseudomonas syringae GC_percentage = 58.07%")
